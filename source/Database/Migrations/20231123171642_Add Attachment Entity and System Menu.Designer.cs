...
namespace Architecture.Database.Migrations
{
    ...
    [Migration("20231123171642_Add Attachment Entity and System Menu")]
    partial class AddAttachmentEntityandSystemMenu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Architecture.Domain.Attachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ATTACHMENTS", "Architecture");
                });

            modelBuilder.Entity("Architecture.Domain.AttachmentGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ATTACHMENT_GROUPS", "Architecture");
                });
            ...
            modelBuilder.Entity("Architecture.Domain.SystemMenu", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("SYSTEM_MENUS", "Architecture");
                });
            ...
            modelBuilder.Entity("Architecture.Domain.Attachment", b =>
                {
                    b.HasOne("Architecture.Domain.AttachmentGroup", "AttachmentGroup")
            ...
            modelBuilder.Entity("Architecture.Domain.SystemMenu", b =>
                {
                    ...
                    b.HasOne("Architecture.Domain.SystemMenu", "Parent")
                        .WithMany("Child")
                        .HasForeignKey("ParentId");
